...
int Iniciar_Configuracao_Socket(){
    ...
    sock.sin_addr.s_addr = inet_addr("192.168.43.70");
...
int Comunicao_servidor(fila_textos_t *_textos){
    ...
    if(bytes > 0){
        ...
        Adicionar_novo_texto(_textos, Criar_Texto(texto_split, (75 * ALTURA_DA_TELA) / 1080, (200 * ALTURA_DA_TELA) / 1080 , Definir_Cor(255,255,255), 0));
